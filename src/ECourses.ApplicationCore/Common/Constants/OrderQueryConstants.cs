namespace ECourses.ApplicationCore.Common.Constants
{
    public class CategoryOrderQueryConstants
    {
    ...
    public class AuthorOrderQueryConstants
    {
        public const string FirstNameAsc = "firstName_asc";
        public const string FirstNameDesc = "firstName_desc";
